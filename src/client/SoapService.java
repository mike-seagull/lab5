 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://lab5", wsdlLocation = "http://localhost:8080/Lab5/wsdl/Soap.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICE_QNAME = new QName("http://lab5", "SoapService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Lab5/wsdl/Soap.wsdl");
    ...
    public Soap getSoap() {
        return super.getPort(new QName("http://lab5", "Soap"), Soap.class);
    }
    ...
    public Soap getSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab5", "Soap"), Soap.class, features);
    }
